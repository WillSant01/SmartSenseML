...
if __name__ == "__main__":
    model_path = Path("trained_model")  # Update with your model path
    detector = GestureDetector(model_path)
    
    with CustomTskin("YOUR_DEVICE_ADDRESS", Hand.RIGHT) as tskin:
        ...
        while True:
            ...
            if current_time - last_sample_time >= 0.05:  # 50ms sampling
